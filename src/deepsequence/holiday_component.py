...
Uses PWL calibration for holiday windows (days before/after holiday).
Requires shared ID input from Trend component.
"""
...
from tensorflow.keras.layers import (
    ...
    Embedding, Reshape, Flatten, BatchNormalization
)
